...
public class QuestionDAO {
    ...
    public static void addQuestion(Question question) {
        ...
        MainActivity.db = FirebaseFirestore.getInstance();
        DocumentReference reference = MainActivity.db.collection("questions").document();
        question.setId(reference.getId());
        Log.e("lalala",""+ reference.getId());
        reference.set(question).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
